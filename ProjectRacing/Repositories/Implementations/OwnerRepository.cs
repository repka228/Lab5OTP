...
public class OwnerRepository(IConnectionString connectionString, ILogger<OwnerRepository> logger) : IOwnerRepository
{
    ...
    public void CreateOwner(Owner owner)
    {
        ...
        try
        {
            ...
            connection.Open();
            var queryInser = @"INSERT INTO Owner (NameOfOwner, Number, Adress) VALUES (@NameOfOwner, @Number, @Adress)";
    ...
    public void UpdateOwner(Owner owner)
    {
        ...
        try
        {
            using var connection = new NpgsqlConnection(_connectionString.ConnectionString);
            connection.Open();
            var queryUpdate = @"UPDATE Owner (NameOfOwner, Number, Adress) VALUES (@NameOfOwner, @Number, @Adress)";
